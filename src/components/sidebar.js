  ...
  return (
    <div div className= "sidecontainer">
      ...
      <ul className="sidebar">
        <li>
          <img className="logo" onClick= {()=>navigate("/")} style={{cursor:"pointer"}} src={logo} />
        </li>
        {
        ...
        <li>
          ...
          <span onClick={()=>navigate("/signature")}>Signature</span>
        </li>
          )
        }
        ...
        {location.pathname.toLowerCase() == "/agreement"?(
          ...
          <span onClick={()=>navigate("/agreement")}>Agreements</span>
        </li>
        )}
        ...
        {location.pathname.toLowerCase() == "/team"?(
          ...
          <span onClick={()=>navigate("/team")}>Teams</span>
        </li>
        )}
        {location.pathname.toLowerCase() == "/setting"?( <li>
          <span>
